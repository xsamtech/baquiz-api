...
use App\Http\Controllers\Api\AI\AiSettingController;
...
Route::apiResource('ai/messages', AiMessageController::class);
Route::apiResource('ai/message-files', AiMessageFileController::class);
Route::apiResource('ai/tool-calls', AiToolCallController::class);
